...
// let text = "My name is " Parth Patel " & I am a Full Stack Developer. ";
// let text =
//   "My name is ' Parth Patel ' & \\ I am a \"Full Stack \" Developer. ";
// // let text = 'My name is " Parth Patel " & I am a Full Stack Developer. ';
...
// let text = "Parth Patel";
// console.log(text.indexOf("Parth"));
// The indexOf() method is case sensitive.
// console.log(text.indexOf("Patel"));
...
// let result = text.substring(1);
//? Optional
// let result = text.replace("JavaScript", "Parth");
// let result = text.replaceAll("JavaScript", "Parth");
...
// let replacedString = originalString.replace(/world/gi, "Parth");
...
//   return count;
// };
//   console.log(checkAllVowelPresentOrNot("my name u is Parth @  Patel"));
