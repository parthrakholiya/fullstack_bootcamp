...
// function greet() {
//   console.log("Hello Guys, Welcome to JS");
// }
...
//! Write a JavaScript program that defines a function called greet to welcome individuals to the JS Course. The function should take a name parameter and output the message "Hello [name], Welcome to JS Course". Call the function twice, once with the argument "Aakash" and once with the argument "ram".
// function greet(name) {
...
// console.log(isReverse("parth patel"));
